		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Suppliers",
									"targetURL": "#nsbuinessparter-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nsbuinessparter-display": {
								"semanticObject": "nsbuinessparter",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ns.buinessparter",
									"url": sap.ui.require.toUrl("ns/buinessparter")
								}
							}
						}
					}
